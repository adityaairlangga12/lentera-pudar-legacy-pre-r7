...
## 2. Standar Rigging Armature, Biomekanik & Dual-Mode Scarf (SOP 3)
...
- **Scarf Spring Bones (Dual-Mode)**: Rantai 5-bone (`Scarf_01` s.d. `Scarf_05`) dengan parameter *Spring-Damper* (Stiffness: 0.4–0.6, Damping: 0.3–0.5) — siap beralih antara Chaos Cloth (gameplay) dan Hand-Keyframed Control Rig (cutscene naratif).
...
## 3. Shading & Material The Triad 3D (SOP 2 — Zero Black Outline)
