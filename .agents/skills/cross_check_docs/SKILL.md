...
4. **Standar QA/QC 6-DoD & Validasi Emosional**:
   - Menegakkan verifikasi 6 pilar Definition of Done (DoD), Stage-Gate 0 s.d. 7, klasifikasi bug 4-tier (Blocking, Critical, Major, Minor), dan *Intended vs Perceived Emotional Gate* (`[Needs Human Playtest Validation]`).
...
6. **Standar Biomekanika, Sinematografi, Arketipe Musuh, Level Spasial, Ekspresi Wajah & Kena-Grade Art**:
   - Verifikasi konsistensi parameter:
     - **Cinematics & Cutscenes**: Bahasa kamera per sektor duka (S1 kaku, S2 shake, S3 Dutch angle, S4 long take kerdil, S5 stabil fajar), transisi seamless tanpa hard cut hitam, cakupan 3-shot, sinkronisasi presisi cut ke FACS AU (`AU1`, `AU4`, `AU17`), dan emotional DoF.
