...
description: "Skill audit konsistensi silang yang dipicu via /cross-check-docs. Memeriksa konsistensi antara lore Lentera Pudar, GDD, AGENTS.md, SOP Workflow, Few-Shot Calibration, Reference Board, dan seluruh master references 3D Blender 5.2 LTS / Unreal Engine 5."
---
...
3. **Mekanik Khusus Lentera Pudar 3D**:
   - *The Fading Scarf* (Chaos Cloth & Spring Bones 4-stage sacrifice), *Cursed Ice Talons* (shader emissive live-driven MPC), *The Sealed Eyepatch* (Perception mechanic Risk-Reward +3 pts/s), *Live Mental Morphing Environment*, *Binaural Spatial Whispers*, dan *The Hollow Reflection* terdokumentasi konsisten di seluruh dokumen.
...
6. **Standar Parameter Numerik (ADR-016 & Style Guide)**:
