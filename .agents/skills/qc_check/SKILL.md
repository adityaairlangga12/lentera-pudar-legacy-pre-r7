...
```mermaid
flowchart TD
    A["3D Asset / Blueprint / Audio Under Test"] --> B["Tier 1: 3D Visual & Material Fidelity (The Triad)"]
...
- [ ] **Audio Dynamic Ducking & Binaural Spatialization**:
  - Normalisasi loudness $-14$ s.d. $-16$ LUFS dengan audio ducking ($-6\text{ dB}$) saat narasi/bisikan jiwa beku.
...
- [x] Tier 1: 3D Visual & Material Fidelity (The Triad) — PASS
