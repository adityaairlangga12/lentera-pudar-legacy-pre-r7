...
> Melengkapi [expert-psychology.md](file:///d:/GodotProjects/Lentera-Pudar/references/expert-psychology.md), [style-guide.md](file:///d:/GodotProjects/Lentera-Pudar/references/style-guide.md), [level-design-storytelling.md](file:///d:/GodotProjects/Lentera-Pudar/references/level-design-storytelling.md), dan [qa-qc-framework.md](file:///d:/GodotProjects/Lentera-Pudar/references/qa-qc-framework.md). Menetapkan antarmuka pengguna yang meminimalkan beban kognitif (*cognitive load*) dan menjamin aksesibilitas inklusif untuk seluruh pemain.
